...
export function Contact() {
  ...
  return (
    <section id="contact" className="relative bg-white py-12 sm:py-16 lg:py-20 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
              ...
              <div className="pt-2 sm:pt-4">
                <button type="submit" disabled={status === "loading"}
                  ...
                  className="w-full bg-black hover:bg-black/80 text-white text-sm font-medium uppercase tracking-[0.15em] py-3 sm:py-4 px-6 transition-colors duration-300 disabled:opacity-60">
          ...
          <div className="relative flex items-center justify-center min-h-[200px] sm:min-h-[250px] lg:min-h-[300px]">
            ...
            {/* Isometric CD Logo */}
            <div className="w-full max-w-[280px] sm:max-w-[400px] lg:max-w-[600px] xl:max-w-[800px] flex items-center justify-center">
              <IsometricCDLogo />
            </div>
          </div>
        </div>
